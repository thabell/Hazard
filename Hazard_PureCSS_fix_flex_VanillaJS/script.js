...
try {
	...
	} catch { console.log("main-navigation__user-login works not"); }
	/* /main-nav log in */
...
var evaluation__modelList = document.querySelectorAll(".evaluation__model"); 
...
function ev_table_new_row_bottom(event) {
	...
	var exmpl_row = null;
	if (event_row.querySelector("td.td-with-new-row-button") && (tbody.querySelector("tr") != event_row)) { 
...
function tr_left_highlight_row_button_event(event) {
	...
	function tr_left_highlight_row_button_event_reset(event1) { 
